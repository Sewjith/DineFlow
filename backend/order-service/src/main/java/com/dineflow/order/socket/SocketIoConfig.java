package com.dineflow.order.socket;
...
/**
 * Configures the standalone Socket.IO (Netty) server used to push live order updates to the
 * admin Kitchen/Orders views. Only connections presenting a valid admin JWT (as {@code ?token=})
